...
bool checkRemote() // regarde si un ordre est envoye via la telecommande
{
  ...
  if ( (data == 60) || (data == 192) || (data == 48) || (data == 240) || (data == 12) || (data == 204) ) // || (data == 204) ajouter quand bouton 5 pas utilisé pour test
  {
...
void scrutationLente() // centre la lumière refletee par rapport au cellules photovoltaiques
{
  ...
  {
    while ( valNord - valSud != 0 && valEst - valOuest != 0 ) // tant qu on n est pas centre
    {
